...
<html>
  ...
  <!--   <div id="u78" class="ax_文本">
    ...
    <!-- Unnamed (文本框(多行)) -->
  <!--   <div id="u80" class="ax_文本框_多行_">
      <textarea id="u80_input"></textarea>
    </div>
  ...
  <!--   <div id="u81" class="ax_文本">
   ...
   <!--    <input id="u83_input" type="text" value="admin"/>
    </div>
  ...
  <!--   <div id="u120" class="ax_文本框_单行_">
   ...
   <!--  <div id="u128" class="ax_文本">
    ...
    <!-- Unnamed (文本框(单行)) -->
   <!--  <div id="u130" class="ax_文本框_单行_">
      <input id="u130_input" type="text" value=""/>
    </div>

    <!-- Unnamed (HTML Button) -->
   <!--  <div id="u131" class="ax_html_button">
      <input id="u131_input" type="submit" value="浏览"/>
    </div>
